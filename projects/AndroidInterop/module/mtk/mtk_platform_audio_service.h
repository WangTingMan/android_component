...
class mtk_platform_audio_service : public local_audio_service
{

public:

    static inline constexpr const char* s_module_name = "mtk_platform_audio_service";

    mtk_platform_audio_service();
